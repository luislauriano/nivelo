...
st.markdown(
    ...
    <div class="custom-text-tres">
        Aqui você consegue <strong>prever</strong> prever a chance de um aluno possuir dificuldade ou não com base o <strong>na prova de nivelamento aplicada</strong>,
